...
class CompiledProgramTests(unittest.TestCase):
    ...
    def test_diagnostics_and_target_options(self) -> None:
        ...
        positional = compiler.compile_program_result(CPU_MODULE, native.Target.CPU, 0, 0, "", "generic", "")
        self.assertTrue(positional.ok, positional.diagnostics)
        self.assertEqual(positional.cpu, "generic")
        self.assertEqual(positional.apple_platform, "macos")
