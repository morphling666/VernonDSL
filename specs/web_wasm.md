...
The browser path keeps the compiler, pipeline, and CPU entry contracts unchanged:
...
load and resolve multiple statically registered pipelines without a bundle directory, and exercise
