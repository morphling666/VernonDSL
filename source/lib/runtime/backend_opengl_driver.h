...
constexpr GlEnum kColor = 0x1800;
...
struct OpenGLDriver {
    ...
    void(VERNON_GL_CALL *shaderSource)(GlUint, GlSize, const char *const *, const GlInt *){};
    ...
    void(VERNON_GL_CALL *bufferSubData)(GlEnum, GlIntPtr, GlSizePtr, const void *){};
    void *(VERNON_GL_CALL *mapBufferRange)(GlEnum, GlIntPtr, GlSizePtr, GlBitfield){};
    GlBoolean(VERNON_GL_CALL *unmapBuffer)(GlEnum) {};
    ...
    void(VERNON_GL_CALL *vertexAttribPointer)(GlUint, GlInt, GlEnum, GlBoolean, GlSize, const void *){};
    ...
    void(VERNON_GL_CALL *framebufferTexture2D)(GlEnum, GlEnum, GlEnum, GlUint, GlInt){};
    GlEnum(VERNON_GL_CALL *checkFramebufferStatus)(GlEnum) {};
    void(VERNON_GL_CALL *drawBuffers)(GlSize, const GlEnum *){};
    void(VERNON_GL_CALL *clearBufferfv)(GlEnum, GlInt, const float *){};
    ...
    void(VERNON_GL_CALL *drawElementsInstanced)(GlEnum, GlSize, GlEnum, const void *, GlSize){};
    ...
    void(VERNON_GL_CALL *uniformMatrix2fv)(GlInt, GlSize, GlBoolean, const float *){};
    void(VERNON_GL_CALL *uniformMatrix3fv)(GlInt, GlSize, GlBoolean, const float *){};
    void(VERNON_GL_CALL *uniformMatrix4fv)(GlInt, GlSize, GlBoolean, const float *){};
    void(VERNON_GL_CALL *uniform1i)(GlInt, GlInt){};
    void(VERNON_GL_CALL *activeTexture)(GlEnum){};
    void(VERNON_GL_CALL *genTextures)(GlSize, GlUint *){};
    void(VERNON_GL_CALL *deleteTextures)(GlSize, const GlUint *){};
    void(VERNON_GL_CALL *bindTexture)(GlEnum, GlUint){};
    void(VERNON_GL_CALL *texImage2D)(GlEnum, GlInt, GlInt, GlSize, GlSize, GlInt, GlEnum, GlEnum, const void *){};
    void(VERNON_GL_CALL *texSubImage2D)(GlEnum, GlInt, GlInt, GlInt, GlSize, GlSize, GlEnum, GlEnum, const void *){};
    void(VERNON_GL_CALL *pixelStorei)(GlEnum, GlInt){};
    void(VERNON_GL_CALL *readPixels)(GlInt, GlInt, GlSize, GlSize, GlEnum, GlEnum, void *){};
    void(VERNON_GL_CALL *genSamplers)(GlSize, GlUint *){};
    void(VERNON_GL_CALL *deleteSamplers)(GlSize, const GlUint *){};
    void(VERNON_GL_CALL *samplerParameteri)(GlUint, GlEnum, GlInt){};
