...
bool VulkanDriver::loadInstance(VkInstance instance) {
...
bool VulkanDriver::loadDevice(VkDevice device) {
#define VERNON_LOAD_VULKAN_DEVICE(member, symbol)                              \
  ...
  VERNON_LOAD_VULKAN_DEVICE(getImageMemoryRequirements,
  ...
  VERNON_LOAD_VULKAN_DEVICE(createGraphicsPipelines,
