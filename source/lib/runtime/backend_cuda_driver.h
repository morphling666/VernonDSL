...
struct CudaDriver {
    ...
    using DeviceGetAttribute = CudaResult (*)(int *, int, CudaDevice);
    using DriverGetVersion = CudaResult (*)(int *);
    ...
    using CopyHostToDevice = CudaResult (*)(CudaDevicePointer, const void *, size_t);
    using CopyDeviceToHost = CudaResult (*)(void *, CudaDevicePointer, size_t);
    using ModuleLoadData = CudaResult (*)(CudaModule *, const void *, unsigned, int *, void **);
    using ModuleGetFunction = CudaResult (*)(CudaFunction *, CudaModule, const char *);
    using ModuleUnload = CudaResult (*)(CudaModule);
    using LaunchKernel = CudaResult (*)(CudaFunction, unsigned, unsigned, unsigned, unsigned, unsigned, unsigned,
