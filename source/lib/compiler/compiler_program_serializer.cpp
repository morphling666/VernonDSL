...
llvm::json::Object serializeCanonicalProgram(CanonicalProgramSerializationPlan plan) {
    llvm::json::Object program{
        {"stages", std::move(plan.stages)}, {"parameters", llvm::json::Array()}, {"storages", std::move(plan.storages)},
        {"values", std::move(plan.values)}, {"graphs", std::move(plan.graphs)},  {"abi", std::move(plan.abi)},
    };
