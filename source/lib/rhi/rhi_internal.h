...
VERNON_RHI_CAPI bool endCommandRendering(VernonRhiDevice device, uint64_t native, VernonRhiBackend backend,
                                         ...
                                         size_t color_count, uint64_t depth_resource);
VERNON_RHI_CAPI bool clearCommandColor(VernonRhiDevice device, uint64_t native, VernonRhiBackend backend,
                                       uint32_t backend_kind, int32_t x, int32_t y, uint32_t width, uint32_t height,
                                       uint32_t layers, uint64_t target, uint32_t location, const float color[4]);
VERNON_RHI_CAPI bool clearCommandDepthStencil(VernonRhiDevice device, uint64_t native, VernonRhiBackend backend,
